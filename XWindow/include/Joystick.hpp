 ...
 * ==========================================================================
 *
 *       Filename:  Joystick.hpp
 *
 *    Description:  Joystick class declaration 
 *
 *        Version:  1.0
 *        Created:  27/01/22 11:22:25
 *       Revision:  none
 *       Compiler:  gcc
 *
...
/// \ingroup window
///
/// xwc::Joystick provides an interface to the state of the
...
/// and JoystickButtonReleased events, xwc::Joystick can retrieve the
...
///
/// SFML supports:
/// \li 8 joysticks (xwc::Joystick::Count)
/// \li 32 buttons per joystick (xwc::Joystick::ButtonCount)
/// \li 8 axes per joystick (xwc::Joystick::AxisCount)
///
...
/// you must call xwc::Joystick::update explicitly.
///
/// Usage example:
/// \code
/// // Is joystick #0 connected?
/// bool connected = xwc::Joystick::isConnected(0);
///
/// // How many buttons does joystick #0 support?
/// unsigned int buttons = xwc::Joystick::getButtonCount(0);
///
/// // Does joystick #0 define a X axis?
/// bool hasX = xwc::Joystick::hasAxis(0, xwc::Joystick::X);
///
/// // Is button #2 pressed on joystick #0?
/// bool pressed = xwc::Joystick::isButtonPressed(0, 2);
///
/// // What's the current position of the Y axis on joystick #0?
/// float position = xwc::Joystick::getAxisPosition(0, xwc::Joystick::Y);
/// \endcode
///
/// \see xwc::Keyboard, xwc::Mouse
///
////////////////////////////////////////////////////////////
