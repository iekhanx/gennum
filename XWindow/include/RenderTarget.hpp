 ...
 *
 *    Description:  RenderTarget class declaration
 *
 *        Version:  1.0
 *        Created:  26/01/22 14:31:57
 *       Revision:  none
 *       Compiler:  gcc
 *
...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Tell if the render target will use sRGB encoding when 
    ///                     drawing on it
    ///
    ...
    ///
    /// \return True if operation was succesxwcul, false otherwise
    ///
    ////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Reset the internal OpenGL states so that the target is 
    ///         ready for drawing
    ///
    /// This function can be used when you mix SFML drawing
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Apply a new tranxwcorm
    ///
    /// \param tranxwcorm Tranxwcorm to apply
    ///
    ////////////////////////////////////////////////////////////
    ...
    struct StatesCache
    {
        ...
        bool      viewChanged;    //!< Has the current view changed since draw?
        BlendMode lastBlendMode;  //!< Cached blending mode
        uint64_t  lastTextureId;  //!< Cached texture
        bool      texCoordsArrayEnabled; //!< Is GL_TEXTURE_COORD_ARRAY enabled?
        bool      useVertexCache; //!< Did we previously use the vertex cache?
        Vertex    vertexCache[VertexCacheSize]; //!< Pre-transformedverticescac
    };
    ...
    uint64_t    m_id;          //!< Unique number that identifies RenderTarget
};
...
////////////////////////////////////////////////////////////
/// \class xwc::RenderTarget
/// \ingroup graphics
///
/// xwc::RenderTarget defines the common behavior of all the
/// 2D render targets usable in the graphics module. It makes
/// it possible to draw 2D entities like sprites, shapes, text
/// without using any OpenGL command directly.
///
/// A xwc::RenderTarget is also able to use views (xwc::View),
/// which are a kind of 2D cameras. With views you can globally
/// scroll, rotate or zoom everything that is drawn,
/// without having to tranxwcorm every single entity. See the
/// documentation of xwc::View for more details and sample pieces of
...
///
/// \see xwc::RenderWindow, xwc::RenderTexture, xwc::View
///
////////////////////////////////////////////////////////////
