 ...
 * ==========================================================================
 *
 *       Filename:  InputSoundFile.hpp
 *
 *    Description:  InputSoundFile class declaration 
 *
 *        Version:  1.0
 *        Created:  27/01/22 13:44:42
 *       Revision:  none
 *       Compiler:  gcc
 *
 ...
 * ==========================================================================
 */
#ifndef _INPUTSOUNDFILE_HPP
#define _INPUTSOUNDFILE_HPP
...
public:
    ...
    ///
    /// Because of minimp3_ex limitation, for MP3 files with big 
    /// (>16kb) APEv2 tag,
    ...
    ///
    /// \return True if the file was succesxwcully opened
    ///
    ////////////////////////////////////////////////////////////
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] uint64_t read(int16_t* samples, uint64_t maxCount);
...
private:
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    SoundFileReader* m_reader;       //!< Reader that handles I/O on 
                                     //!< the file's format
    InputStream*     m_stream;       //!< Input stream used to access
                                     //!< the file's data
    bool             m_streamOwned;  //!< Is the stream internal or external?
    uint64_t         m_sampleOffset; //!< Sample Read Position
    uint64_t         m_sampleCount;  //!< Total number of samples in the file
...
#endif // _INPUTSOUNDFILE_HPP


////////////////////////////////////////////////////////////
/// \class xwc::InputSoundFile
/// \ingroup audio
///
/// This class decodes audio samples from a sound file. It is
/// used internally by higher-level classes such as xwc::SoundBuffer
/// and xwc::Music, but can also be useful if you want to process
/// or analyze audio files without playing them, or if you want to
/// implement your own version of xwc::Music with more specific
/// features.
///
/// Usage example:
/// \code
/// // Open a sound file
/// xwc::InputSoundFile file;
...
/// \endcode
///
/// \see xwc::SoundFileReader, xwc::OutputSoundFile
///
////////////////////////////////////////////////////////////
