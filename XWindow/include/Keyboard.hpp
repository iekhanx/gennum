 ...
 *
 *    Description:  Keyboard class declaration 
 *
 *        Version:  1.0
 *        Created:  27/01/22 09:53:26
 *       Revision:  none
 *       Compiler:  gcc
 *
...
/// \ingroup window
///
/// xwc::Keyboard provides an interface to the state of the
...
/// xwc::Keyboard can retrieve the state of a key at any time
...
/// Usage example:
/// \code
/// if (xwc::Keyboard::isKeyPressed(xwc::Keyboard::Left))
/// {
///     // move left...
/// }
/// else if (xwc::Keyboard::isKeyPressed(xwc::Keyboard::Right))
/// {
///     // move right...
/// }
/// else if (xwc::Keyboard::isKeyPressed(xwc::Keyboard::Escape))
/// {
///     // quit...
/// }
/// \endcode
///
/// \see xwc::Joystick, xwc::Mouse, xwc::Touch
///
////////////////////////////////////////////////////////////
