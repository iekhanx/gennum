 ...
 * ========================================================================
 *
 *       Filename:  GlxContext.cpp
 *
 *    Description:  GlxContext class implementation 
 *
 *        Version:  1.0
 *        Created:  06/02/22 18:36:05
 *       Revision:  none
 *       Compiler:  gcc
 *
...
// Headers
////////////////////////////////////////////////////////////
#include "WindowImplX11.hpp" // important to be included first (conflict: None)
...
namespace
{
    ...
    void ensureExtensionsInit(::Display* display, int screen)
    {
        ...
        if (!initialized)
        {
            ...
            gladLoadGLX(display, screen, xwc::priv::GlxContext::getFunction);
        }
    }
